...
export class News extends Component {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=cbbd881c227d46938c2b85e6c9ca2163&page=${this.state.page}&pageSize=${this.props.pageSize}`;
